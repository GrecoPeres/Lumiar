...
export const OfferTexts = {
    firstText: "Visão de Futuro",
    secondText: "Nosso Compromisso",
    list: [
        {
            listCaption: "Missão",
            text: "Beneficiar o comércio, a indústria e demais ramos a executar suas atividades com a segurança de que o seu patrimônio e as pessoas que o compõem estarão protegidos do risco de incêndio.",
        },
        {
            listCaption: "Visão",
            text: "Ser referência na área de combate a incêndio, mantendo o compromisso com a proteção do patrimônio físico e humano e a qualidade do serviço prestado.",
        }
        , {
            listCaption: "Valores",
...
export const MembershipPlans = {
    ...
    cards: [
        ...
        {
            amount: "BRIGADA DE INCÊNDIO",
            category: "brigada_incendio",
            duration: "",
            caption: "",
            benefits: ["A brigada de incêndio atua em edificações e áreas de risco, na prevenção e no combate ao princípio de incêndio, abandono de área e primeiros socorros, visando, em caso de sinistro, proteger a vida e o patrimônio, reduzir os danos ao meio ambiente, até a chegada do socorro especializado."]
          },
    ]
}
...
export const ContactTexts = {
    ...
    paragraph: "Você pode entrar em contato com qualquer um de nossos especialistas para agendar uma consulta. Nossos serviços de consultoria e inspeções em locais estão dentro do escopo dos nossos serviços. Sua segurança contra incêndios é nossa prioridade! Prevenir incêndios é preservar vidas e patrimônios!",
    button: "Fale agora!"
}
