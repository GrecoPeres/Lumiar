...
const Offers = () => {
    ...
    const renderIcon = useCallback((element: number) => {
        switch (element) {
            case 0:
                return <Briefcase size={50} color="currentColor" weight="light" />;
            case 1:
                return <Eye size={50} color="currentColor" weight="light" />;
            case 2:
                return <AlignBottom  size={50} color="currentColor" weight="light" />;
            default:
                return "";
        }
    }, [])
